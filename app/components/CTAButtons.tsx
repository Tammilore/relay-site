...
const CTAButtons: React.FC = () => {
  return (
    <div className="flex hidden gap-x-2 md:flex ml-12 pt-3">
        ...
        <Link href="https://github.com/Relay/relay" className="px-3 py-[0.45rem] text-sm font-medium text-white bg-gray-900 rounded-xl hover:bg-gray-800 border border-gray-900">
          Run locally
        </Link>
      </div>
  );
